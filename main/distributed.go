...
func creatCache(cacheCap int, getter gcache.Getter) *gcache.Cache {
	if getter == nil {
...
func startCacheServer(addr string, addrs []string, c *gcache.Cache) {
...
func startAPIServer(apiAddr string, cache *gcache.Cache) {
